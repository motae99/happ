...
class InvoiceProduct extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['product_id', 'quantity', 'buying_rate', 'selling_rate', 'inventory_id' ], 'required'],
            [['invoice_id', 'product_id', 'quantity', 'buying_rate', 'selling_rate', 'discount', 'inventory_id', 'discount'], 'integer'],
            // [['discount',], 'safe'],
