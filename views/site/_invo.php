  ...
  <div class="col-sm-8 eArLangCss">
    <table class="table table-bordered table-responsive">
        <tr class="<?=$model->client->color_class?>">
          ...
          <th style="color: white;"><?= Yii::t('app', 'Item')?></th>
          <th style="color: white;"><?= Yii::t('app', 'Quantity')?></th>
          <th style="color: white;"><?= Yii::t('app', 'Price')?></th>
          <th style="color: white;"><?= Yii::t('app', 'LineTotal')?></th>
        </tr>
          <?php 
