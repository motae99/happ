...
/**
 * SystemAccountController implements the CRUD actions for SystemAccount model.
 */
class SystemAccountController extends Controller
{
    ...
    /**
     * Lists all SystemAccount models.
     * @return mixed
     */
    ...
    /**
     * Displays a single SystemAccount model.
     * @param integer $id
     * @return mixed
     */
     ...
     * @param integer $id
     * @return SystemAccount the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SystemAccount::findOne($id)) !== null) {
            return $model;
        }
